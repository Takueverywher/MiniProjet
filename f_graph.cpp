...
void f_graph::setTitle(char* _title)
{
...
{
     showTextInBox(_shownInfo,_newBeginKey,1,50,6,108,19);
     };
...
void f_graph::makeSkeleton(const WORD _skeletonColor)
{
     ...
     box(5,2,110,4); //top box
     box(5,5,110,20); //center - out box
     box(7,6,48,19); //left - menu box
     box(50,6,108,19); //right - screen box
     box(5,21,110,23); //bottom box
